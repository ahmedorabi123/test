...
puts "========================================================"
# Note: Shopify webhook registration + data backfill are kicked off AFTER
# Puma binds its port (see config/puma.rb on_worker_boot). Running them here
# would push past Render's port-scan timeout and kill the deploy.
